...
fighter_table <- df %>% 
  ...
  select(-round_finished, -rounds, -time, -date, -strike_differential, -sig_strike_differential) %>%
...
```{r}
# Export tables 
write_csv(fight_table, "fights.csv")
write_csv(fighter_table, "fighter_table.csv")
```
